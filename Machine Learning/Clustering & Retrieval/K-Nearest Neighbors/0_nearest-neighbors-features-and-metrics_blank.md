...
<pre>| 0            | 1       | 0.00169288  | 9.002ms      |</pre>



<pre>| Done         |         | 100         | 165.008ms    |</pre>
...
a = graphlab.toolkits.distances.euclidean(obama,bush)
b = graphlab.toolkits.distances.euclidean(bush,biden)
c = graphlab.toolkits.distances.euclidean(obama,biden)

print a, b, c
```

    34.3947670438 32.7566787083 33.0756708171
...
```python
tf_join = obama_tf_idf.join(schiliro_tf_idf, on='word').rename({'weight':'Obama', 'weight.1':'Schiliro'}).sort('Obama', ascending=False)
tf_join
```
...
<pre>| 0            | 1       | 0.00169288  | 19.003ms     |</pre>



<pre>| Done         |         | 100         | 223.011ms    |</pre>
...
<pre>| 0            | 1       | 0.00169288  | 31.006ms     |</pre>



<pre>| Done         |         | 100         | 197.009ms    |</pre>
...
```
    ...
    <matplotlib.figure.Figure at 0x769b6470>
