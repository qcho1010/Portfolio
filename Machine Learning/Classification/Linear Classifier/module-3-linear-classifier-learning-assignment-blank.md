...
```python
products[products['perfect'] >= 1].num_rows()
```
...
products['intercept'].head()
features = ['intercept'] + important_words
features_sframe = products[features]
...
measures = predictions == products['sentiment'] 
...
print(len(word_coefficient_tuples))
...
word_coefficient_tuples.sort(key = itemgetter(1), reverse = True)
print(word_coefficient_tuples[:10])
```

    [('great', 0.066546084170457709), ('love', 0.065890762922123258), ('easy', 0.064794586802578394), ('little', 0.045435626308421365), ('loves', 0.044976401394906038), ('well', 0.030135001092107063), ('perfect', 0.029739937104968462), ('old', 0.020077541034775385), ('nice', 0.018408707995268992), ('daughter', 0.017703199905701694)]
...
```
    ...
    [('monitor', -0.02448210054589172), ('return', -0.02659277846224728), ('back', -0.027742697230661334), ('get', -0.028711552980192585), ('disappointed', -0.028978976142317068), ('even', -0.030051249236035804), ('work', -0.033069515294752723), ('money', -0.038982037286487116), ('product', -0.04151103339210889), ('would', -0.053860148445203142)]
