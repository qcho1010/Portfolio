...
This presentation will briefly but comprehensively pitch an [application](https://kyucho.shinyapps.io/nextword/) for predicting the next word.
...
* The next word prediction app is hosted on shinyapps.io: [https://kyucho.shinyapps.io/nextword](https://kyucho.shinyapps.io/nextword)

* The whole code of this application, as well as all the milestone report, related scripts, this presentation  etc. can be found in this GitHub repo: [https://github.com/jamin567/DataScienceCapston](https://github.com/jamin567/DataScienceCapston)
